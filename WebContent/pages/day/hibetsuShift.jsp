      ...
      <div id="header">
        <table>
          <tr>
            ...
            <td id="headRight">
              <input value="ÉçÉOÉAÉEÉg" type="button" class="smlButton  smlButton-border-shadow smlButton-border-shadow--radius"  onclick="logout()" />
            </td>
          </tr>
        </table>
      </div>
        ...
        <div style="margin-left:80px;">
          <html:form>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="154px" >
                  <div id="headLeftTbl" style="overflow-x: hidden;overflow-y: hidden;">
                    <table border="1" cellpadding="0" cellspacing="0" class="tblHeader">
                      <tr>
                        <td width="176px" nowrap="nowrap" align="center">
                        éûä‘
                        </td>
                      </tr>
                    </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr height="100%">
                <td valign="top">
                  <div id="bodyLeftTbl" style="overflow-x: auto;overflow-y: hidden;height:402px; ">
